...
\beweis{Beweis} 
	...
	dass ein \(\delta > 0\) existiert mit der Eigenschaft: Für alle \(p \in I\) liegt die \(B_{\delta}(p)\)
	in einem \(U_{\lambda}, \lambda \in \Lambda\) liegt. Dies kann man auch so ausdrücken: 
